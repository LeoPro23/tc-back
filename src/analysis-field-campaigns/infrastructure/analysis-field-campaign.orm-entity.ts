...
export class AnalysisFieldCampaignOrmEntity {
  ...
  @ManyToOne(() => FieldCampaignOrmEntity, (fc) => fc.analyses, {
    nullable: false,
    onDelete: 'CASCADE',
  })
  ...
  @Column({ name: 'is_infected', type: 'boolean', default: false })
  isInfected: boolean;

  @Column({ name: 'plaga_principal', type: 'varchar', nullable: true })
